...
foolproof.is = function (value1, operator, value2, passOnNull) {
    ...
    if (isDate(value1)) {
        ...
        value1 == 'true' || value1 == 'True' ? value1 = true : value1 = false;
        value2 == 'true' || value2 == 'True' ? value2 = true : value2 = false;
        value1 = !!value1;
        value2 = !!value2;
    }
...
(function () {
    ...
    $Unob.adapters.add('requiredif', ['dependentproperty', 'expectedvalue', 'operator', 'pattern'], function (options) {
        var value = {
